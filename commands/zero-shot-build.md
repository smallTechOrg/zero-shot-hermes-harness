...
The skill at `skills/zero-shot-build/SKILL.md` is the source of truth — invoke it and follow it exactly. This command exists only so `/zero-shot-build` works as a slash command in addition to the skill.
